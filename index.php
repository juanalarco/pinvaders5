        ...
        <div class="pure-u-1-2">
            ...
            <table>
              <tr ng-repeat="i in [0,1,2,3]">
                <td ng-repeat="j in [0,1,2]"><img src={{imgs[i][j].img}} alt="celda" class="celda" ng-click="selecPos(i,j)"/></td>
              </tr>
            </table>
            </center>
            <!--Tablero de juego-->
            ...
            <form class="pure-form pure-form-stacked">
              <fieldset>
                <legend>INICIAR TABLERO</legend>
                  <button type="submit" class="pure-button pure-button-primary" ng-click="mueveIA()">Mueve</button>
                </fieldset>
              </form>
          </p>
        </div>
